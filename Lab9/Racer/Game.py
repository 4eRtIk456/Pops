...
pygame.mixer.music.load("D:\\Pops\\Lab9\\Racer\\background_music.mp3")
pygame.mixer.music.play(-1, 0.0)

class Enemy(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("D:\\Pops\\Lab9\\Racer\\Enemy.png")
...
class Player(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("D:\\Pops\\Lab9\\Racer\\Player.png")
...
class Coin(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        self.image = pygame.image.load("D:\\Pops\\Lab9\\Racer\\Coin.png")
...
while True:
    for event in pygame.event.get():
        if event.type == INC_SPEED:
            if COIN_SCORE >= COIN_THRESHOLD:
                SPEED += 0.8
                COIN_SCORE = 0  # Reset after increasing speed
    ...
    if pygame.sprite.spritecollideany(P1, enemies):
        pygame.mixer.Sound("D:\\Pops\\Lab9\\Racer\\crash.wav").play()
        pygame.mixer.music.stop()
        time.sleep(0.8)
        pygame.mixer.Sound("D:\\Pops\\Lab9\\Racer\\GameOver.mp3").play()
